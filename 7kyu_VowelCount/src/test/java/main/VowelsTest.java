...
public class VowelsTest {
    ...
    public void testCase2(){
        assertEquals( 0, Vowels.getCount("AEIOU"));
        assertEquals( 0, Vowels.getCount("ABRACADABRA"));
        assertEquals( 0, Vowels.getCount(""));
        assertEquals(0, Vowels.getCount("PEAR TREE"));
        assertEquals( 0, Vowels.getCount("OA KAK USHAKOV LIL VO KASHU KAKAO"));
